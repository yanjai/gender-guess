...
import { GENDER_LABELS, GENDER_ICONS } from "../../constants/gender";
  ...
  return (
    <div className="step4-result">
      ...
      <div className="answer-display">
        <div className="answer-icon">{GENDER_ICONS[answer] || "👶"}</div>
        <div className="answer-text">
          答案是：{GENDER_LABELS[answer] || answer}
        </div>
      </div>
          ...
          <>
            ...
            <div className="total-info">
              ...
              <div className="total-winnings">
                總獎金：{winners.reduce((sum, w) => sum + w.winnings, 0)} 元
              </div>
            </div>
          </>
        )}
